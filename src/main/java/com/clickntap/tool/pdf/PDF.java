...
public class PDF {
  ...
  /*
   * A4 measures 210 × 297 millimeters. In PostScript, its dimensions are rounded off to 595 × 842 points. We will use a 1190x1684 pixels (595*2x842*2 pixels) resolution.
   */
