...
public class StringUtil {
   ...
   * <p>
   * The language argument is a valid <STRONG>ISO Language Code. </STRONG>. These codes are the lower-case, two-letter codes.
   * <p>
   * The country argument is a valid <STRONG>ISO Country Code. </STRONG> These codes are the upper-case, two-letter codes.
   * <p>
