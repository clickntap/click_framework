...
public class ColorUtil {
  ...
  /**
   * Static table stores the colors. It provides the name and the rgb value of the colors. This should match the color list in ColorPropertyType.
   */
  ...
  /**
   * Gets the integer value of a predefined color. The <code>color</code> should be a predefined color name, otherwise <code>-1</code> is returned.
   * 
   * @param color a given color name, it is case insensitive.
   * @return the integer value of a predefined color, return -1 if the name of the given color is not defined.
   * 
   */
   ...
   * @return a css predefined color if there is a predefined color matches the given <code>rgb</code>, return <code>null</code> otherwise.
   */
   ...
   * @param rgbFormat Color display preference, one of Color display preference constants. For example, CSS_ABSOLUTE_FORMAT that will convert into style "RGB(255,0,0)". If the preference provided is not in the predefined list, then {@link ColorUtil#CSS_ABSOLUTE_FORMAT}will be applied.
   * 
  ...
  /**
   * Formats an color value according to the format preference provided. See {@link #parseColor(String)}for the allowed color value representations.
   * 
   * @param value     a given string containing one of the allowed notation.
   * @param rgbFormat Color display preference, one of Color display preference constants. For example, CSS_ABSOLUTE_FORMAT that will convert into style "RGB(255,0,0)". If the preference provided is not in the predefined list, then {@link ColorUtil#CSS_ABSOLUTE_FORMAT}will be applied.
   * @return a string representation of the color in the target format.
   * @exception NumberFormatException if the <code>String</code> representing a numerical value does not contain a parsable integer.
   * 
   * @see ColorUtil#INT_FORMAT
   * @see ColorUtil#HTML_FORMAT
   * @see ColorUtil#JAVA_FORMAT
  ...
  /**
   * Convert an hex color text into an css absolute or relative format. For example, "#FF0000" to "RGB(255, 0, 0) or to "RGB( 100.0%, 0%, 0%)s".
   * 
   * @param hexColor   an hex color text
   * @param isAbsolute if <tt>true</tt>, return will be in css absolute format, e.g, RGB(255,0,0); if <tt>false</tt>, return will be in css relative format, e.g, RGB(100.0%,0%,0%).
   * 
  ...
  /**
   * Parse a valid css color expressed in absolute or relative format as "RGB(r%,g%,b%)" or "RGB(r,g,b)" and return the integer value of the color.
   * 
   * @param rgbColor input color value of a valid css relative or absolute format.
   * @return an integer value of the color representation. Return <code>-1</code> if the string is not in a valid absolute or relative representation.
   * 
   ...
   * 
   * <ul>
   * <li>A decimal number: "16711680". The number will be clipped into 0~#FFFFFF</li>
   * <li>A hexadecimal number in HTML format. '#' immediately followed by either three or six hexadecimal characters. The three-digit RGB notation (#rgb) is converted into six-digit form (#rrggbb) by replicating digits, not by adding zeros. For example, #fb0 expands to #ffbb00. Values outside "#FFFFFF" will be clipped.</li>
   * <li>A hexadecimal number in Java format: "0xRRGGBB"</li>
   * <li>A css predefined color name: "red", "green", "yellow" etc.</li>
   * <li>A css absolute or relative notation: "rgb(r,g,b)" or "rgb(r%,g%,b%)". 'rgb(' followed by a comma-separated list of three numerical values (either three integer values in the range of 0-255, or three percentage values in the range of 0.0% to 100.0%) followed by '), Values outside the numerical ranges will be clipped. Whitespace characters are allowed around the numerical values.</li>
   * </ul>
   * <p>
   ...
   * 
   * @param value a given string containing one of the allowed notation.
   * @return the integer value of the color, return <code>-1</code> if the value is not in one of the allowed format. If the value is in a valid integer format, return value will be clipped to 0 ~ 0xFFFFFF
   * 
   * 
   */
  ...
  public static int parseColor(String value) {
    ...
    if (first == '#' || (first >= '0' && first <= '9')) {
      if (first == '#' && value.length() == 4) {
        ...
        char[] rrggbb_chars = { '#', rgb_chars[1], rgb_chars[1], rgb_chars[2], rgb_chars[2], rgb_chars[3], rgb_chars[3] };
  ...
  /**
   * Returns the Red, Blue, Green value for a integer RGB color value. The given RGB value should be in the scope of (0~0xFFFFFF), otherwise return <code>null</code>.
   * 
   * @param rgbValue a given integer RGB color value.
   * @return an array containing Red, Blue, Green separately. Return <code>null</code> if the value is not in (0~0xFFFFFF).
   */
   ...
   * @return an array containing Red, Blue, Green separately. Return <code>null</code> if the given color value is not parsable.
   */
